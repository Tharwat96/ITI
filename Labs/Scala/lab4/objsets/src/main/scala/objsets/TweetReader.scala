...
object TweetReader {
  ...
  lazy val gizmodoTweets = TweetReader.ParseTweets.getTweetData("gizmodo", TweetData.gizmodo)
  lazy val techCrunchTweets = TweetReader.ParseTweets.getTweetData("TechCrunch", TweetData.TechCrunch)
  lazy val engadgetTweets = TweetReader.ParseTweets.getTweetData("engadget", TweetData.engadget)
  lazy val amazondealsTweets = TweetReader.ParseTweets.getTweetData("amazondeals", TweetData.amazondeals)
  lazy val cnetTweets = TweetReader.ParseTweets.getTweetData("CNET", TweetData.CNET)
  lazy val gadgetlabTweets = TweetReader.ParseTweets.getTweetData("gadgetlab", TweetData.gadgetlab)
  lazy val mashableTweets = TweetReader.ParseTweets.getTweetData("mashable", TweetData.mashable)
